  ...
  return (
    <main className="min-h-screen bg-onyx px-4 sm:px-6 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        {tab === "demandes" && (
          <>
            {/* ===== CARTE TRAFIC DU SITE ===== */}
            <div className="glass-card rounded-2xl p-5 mb-6">
              <div className="flex items-center gap-2 mb-4">
                <TrendingUp className="w-5 h-5 text-cyan-electric" />
                <h2 className="font-orbitron text-sm font-bold text-white uppercase tracking-wider">
                  Trafic du site
                </h2>
                <button onClick={loadVisits} disabled={loadingVisits}
                  className="ml-auto p-1.5 rounded-lg hover:bg-white/5 transition-colors disabled:opacity-50" title="Rafraîchir">
