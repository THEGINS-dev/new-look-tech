...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-14 pb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            L'excellence technique au service de vos ambitions. Soudure, construction et maintenance de classe en RDC.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li>
              <a href="tel:+243993223896" className="flex items-center gap-3 group">
                <Phone className="w-5 h-5 text-spark-orange shrink-0" />
                <span className="text-gray-400 group-hover:text-white transition-colors text-sm">+243 993 223 896</span>
              </a>
            </li>
            <li>
      ...
      {/* BARRE INFÉRIEURE — pb-24 laisse la place au bouton du chatbot en bas à droite */}
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 pt-6 pb-24 md:pb-8 flex flex-col sm:flex-row justify-between items-center gap-5">
          ...
          {/* Réseaux sociaux : vrais logos cliquables */}
          <div className="flex space-x-6 order-1 sm:order-2">
            {/* Facebook */}
            <a href="https://facebook.com/elisha.lwamba5" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
            ...
            {/* TikTok */}
            <a href="https://tiktok.com/@newlootechservice" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/243993223896" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
